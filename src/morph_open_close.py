...
# 열림 연산 적용
opening = cv2.morphologyEx(img1, cv2.MORPH_OPEN, k1)
# 닫힘 연산 적용
closing = cv2.morphologyEx(img2, cv2.MORPH_CLOSE, k1)


## 그래디언트 연산(팽창 결과값에서 침식 결과값 빼기)
...
# 열림 연산 적용
gradient = cv2.morphologyEx(img, cv2.MORPH_GRADIENT, k2)
